...
//               {/* View Profile Button */}
//               <button className="mt-4 w-full py-3 bg-blue-500 text-white rounded-full hover:bg-blue-700 transition-all shadow-md font-semibold">
//                 View Profile
//               </button>
//             </div>
//           ))
...
export default function Userdashboard() {
  ...
  const handleViewProfile = (tutor) => {
    navigate("/tutor-profile", { state: { tutor } }); // Navigate and pass tutor data
  };
        ...
        {filteredTutors.length > 0 ? (
          filteredTutors.map((tutor, index) => (
            <div key={index} className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2 border border-gray-200 flex flex-col">
              ...
              <button
                onClick={() => handleViewProfile(tutor)} // Add onClick event for navigation
