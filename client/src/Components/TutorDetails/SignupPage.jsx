    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white">
      ...
      <main className="bg-white rounded-b-lg shadow-lg p-8 w-full max-w-lg">
        ...
        <div className="space-y-6">
          {/* Tutor Button */}
          <button 
            className="w-full flex items-center justify-between bg-purple-100 hover:bg-purple-200 text-purple-600 font-medium py-6 px-6 rounded-lg transition shadow-sm"
            onClick={() => navigate("/register-tutor")} // Navigate to tutor signup page
          >
            <div className="flex items-center space-x-4">
              <div className="w-14 h-14 bg-purple-300 text-white rounded-full flex items-center justify-center">
                <FaChalkboardTeacher size={24} />
          ...
          {/* Student Button */}
          <button 
            className="w-full flex items-center justify-between bg-blue-100 hover:bg-blue-200 text-blue-600 font-medium py-6 px-6 rounded-lg transition shadow-sm"
            onClick={() => navigate("/register-student")} // Navigate to student signup page
          >
            <div className="flex items-center space-x-4">
              <div className="w-14 h-14 bg-blue-300 text-white rounded-full flex items-center justify-center">
                <FaUserGraduate size={24} />
