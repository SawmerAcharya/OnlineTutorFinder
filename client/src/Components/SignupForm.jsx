    ...
    <div className="min-h-screen flex">
      ...
      <div className="md:w-1/2 bg-gradient-to-br from-orange-500 to-orange-600 p-8 md:p-12 flex flex-col justify-between text-white">
        <div>
          ...
          <p className="text-orange-100 mb-8 text-lg">
            Join TutorFinder and connect with expert tutors today.
          </p>
        </div>
      ...
      <div className="md:w-1/2 flex items-center justify-center p-6 md:p-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-orange-600 hover:bg-orange-700 text-white font-semibold py-2 px-4 rounded-xl transition duration-300"
            >
              Sign Up
            </button>
          </form>
