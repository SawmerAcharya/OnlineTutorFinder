...
// import { Mail, Lock, Eye, EyeOff, ArrowRight, CheckCircle, Lightbulb, GraduationCap, Users } from "lucide-react";
...
//       <div className="md:w-1/2 bg-gradient-to-br from-teal-500 to-emerald-600 p-8 md:p-12 flex flex-col justify-between text-white">
//         <div>
...
//           <h2 className="text-3xl md:text-4xl font-bold mb-6">Welcome back to your learning journey</h2>
//           <p className="text-teal-100 mb-8 text-lg">Connect with expert tutors and accelerate your learning today.</p>
//         </div>
...
//                   <p className="text-teal-100 text-sm">Find tutors that match your learning style and pace</p>
//                 </div>
//               </div>
//             </div>
...
//                   <p className="text-teal-100 text-sm">Learn from qualified tutors with proven experience</p>
//                 </div>
//               </div>
//             </div>
...
//                   <p className="text-teal-100 text-sm">Join a community of learners and educators</p>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//                   className="pl-10 pr-3 py-3 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors"
...
//                   Password
//                 </label>
//                 <Link to="/ResetPassword" className="text-sm text-teal-600 hover:text-teal-500">
//                   Forgot password?
//                 </Link>
//               </div>
//               <div className="relative">
...
//                   className="pl-10 pr-10 py-3 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors"
//                   placeholder="••••••••"
//                   required
//                 />
//                 <button
...
//               type="submit"
//               disabled={loading}
//               className="w-full py-3 px-4 bg-gradient-to-r from-teal-500 to-emerald-600 text-white rounded-lg hover:from-teal-600 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 transition-colors flex items-center justify-center"
//             >
//               {loading ? (
//                 <svg
...
//             <Link to="/SignupForm" className="text-teal-600 hover:text-teal-500 font-medium">
//               Create an account
//             </Link>
//           </p>
//         </div>
