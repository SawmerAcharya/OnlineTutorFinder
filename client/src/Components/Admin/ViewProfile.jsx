...
//       if (response.data.success) {
//         toast.success(`Tutor ${newStatus}! ✅`);
//         setTutor((prevTutor) => ({ ...prevTutor, status: newStatus })); // Update state
//       } else {
//         toast.error(response.data.message || "Failed to update status.");
//       }
//     } catch (error) {
//       console.error("Error updating status:", error);
//       toast.error(error.response?.data?.message || "Error updating status. Try again.");
//     }
//   };
...
const TutorProfile = () => {
  ...
  //       // Navigate to the admin dashboard and pass the updated status
  //       navigate("/admin"); // You can also pass the status in the URL or via state
  //     } else {
  //       toast.error(response.data.message || "Failed to update status.");
  //     }
  //   } catch (error) {
