...
function ResetPassword() {
  ...
  const onSubmitOTP = async (event) => {
    ...
    // Ensure that all 6 digits are entered
    ...
    try {
      // Call a dedicated endpoint for OTP verification for password reset.
      ...
      if (data.success) {
        ...
        setIsOtpSubmited(true); // Proceed to the new password form only if OTP is valid
      } else {
